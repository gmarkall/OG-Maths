...
#FIXME: Not just copy/paste of create_javadoc.
#FIXME: Parse arguments sensibly
#FIXME: Make generic/sensible and submit upstream
function(create_javadoc_jar _target)
    set(_javadoc_packages)
    set(_javadoc_files)
    set(_javadoc_sourcepath)
    set(_javadoc_classpath)
    ...
    add_custom_target(${_target}_javadoc
        COMMAND ${Java_JAVADOC_EXECUTABLE} ${_javadoc_options}
                            ${_javadoc_files}
                            -subpackages ${_javadoc_packages}
        WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    )

    # create the jar file
    set(_JAVA_TARGET_OUTPUT_NAME "${_target}-javadoc.jar")
    set(_JAVA_JAR_OUTPUT_PATH
      ${CMAKE_JAVA_TARGET_OUTPUT_DIR}/${_JAVA_TARGET_OUTPUT_NAME})
    add_custom_target(${_target}_javadoc_jar ALL
        COMMAND ${Java_JAR_EXECUTABLE} -cf ${_JAVA_JAR_OUTPUT_PATH} *
        WORKING_DIRECTORY ${_javadoc_builddir}
        DEPENDS ${_target}_javadoc
    )
